...
public final class Notification extends com.google.api.client.json.GenericJson {
   ...
   */
  public Notification setCursor(java.lang.String cursor) {
    this.cursor = cursor;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NotificationItem> getNotificationList() {
    return notificationList;
  }

  /**
   * @param notificationList notificationList or {@code null} for none
   */
  public Notification setNotificationList(java.util.List<NotificationItem> notificationList) {
