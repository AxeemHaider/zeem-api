...
public final class Comment extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.util.List<java.lang.Long> commentStar;
   ...
   */
  public Comment setAnonymous(java.lang.Boolean anonymous) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<java.lang.Long> getCommentStar() {
    return commentStar;
  }

  /**
   * @param commentStar commentStar or {@code null} for none
   */
  public Comment setCommentStar(java.util.List<java.lang.Long> commentStar) {
   ...
   */
  public Comment setCommnetSafeKey(java.lang.String commnetSafeKey) {
   ...
   */
  public Comment setPostedOn(java.lang.Long postedOn) {
   ...
   */
  public Comment setSource(java.lang.String source) {
    this.source = source;
    return this;
  }
   ...
   */
  public Comment setStarCount(java.lang.Integer starCount) {
   ...
   */
  public Comment setTaggedUser(java.util.List<java.lang.Long> taggedUser) {
